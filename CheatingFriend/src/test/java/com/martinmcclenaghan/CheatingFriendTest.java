...
public class CheatingFriendTest {

    private long input;
    private List<long[]> answer;

    public CheatingFriendTest(long input, List<long[]> answer) {
        this.input = input;
        this.answer = answer;
    }
    ...
    public void removeTest() {
        ...
        for(int i = 0; i < answer.size(); i++){
            ...
            assertArrayEquals(answer.get(i), CheatingFriendMain.remove(input).get(i));
        }
    }
}