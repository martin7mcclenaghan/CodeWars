...
public class MaxContiguousSumTest {
    ...
    public MaxContiguousSumTest(int[] input, int expected) {
        this.input = input;
    ...
    public void maxContiguousSum() {
        ...
        assertEquals(expected, MaxContiguousSumMain.maxContiguousSumAddition(input));
    }

    @Test
    public void maxContiguousSumAddition() {

        assertEquals(expected, MaxContiguousSumMain.maxContiguousSum(input));
    }
